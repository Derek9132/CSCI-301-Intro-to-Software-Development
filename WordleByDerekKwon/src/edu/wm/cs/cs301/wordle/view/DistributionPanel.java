...
public class DistributionPanel extends JPanel {
	...
	private void calculatePercentages() { //Index 5 out of bounds for length 5, easy mode board part 3
		this.counts = new int[model.getMaximumRows() + 1]; //Plus one fixes above error, effect on percentage not yet known
